...
{
    public partial class InputPosition : Form
    {
        SpreadCounter sc;

        /// <summary>
        /// Initializes a new instance of the <see cref="InputPosition"/> class.
        /// </summary>
        ...
        public InputPosition(SpreadCounter form1)
        {
            InitializeComponent();
        ...
        private void SubmitTrade()
        {
            ...
            if (position > 0)
            {
                string summarystring = String.Format("Long\t{0}\t{1}{2}{3}{4}", PositionTextBox.Text, ContractComboBox.Text, MonthComboBox.Text, year, Environment.NewLine);
            ...
            {
                string summarystring = String.Format("Short\t{0}\t{1}{2}{3}{4}", PositionTextBox.Text, ContractComboBox.Text, MonthComboBox.Text, year, Environment.NewLine);
            ...
            {
                string summarystring = String.Format("Clear\t\t{0}{1}{2}{3}", ContractComboBox.Text, MonthComboBox.Text, year, Environment.NewLine);
                SummaryTextBox.AppendText(summarystring);
                input = new SpreadCounter.Trade(dateobj, 0, 0);
            }
        ...
        private void InputPosition_FormClosing(object sender, FormClosingEventArgs e)
        {
            ClearTrades();
            Hide();
